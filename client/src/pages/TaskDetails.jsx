                        ...
                        <div key={index} className="flex gap-3">
                          ...
                          <div className="space-y-1">
                            <div className="flex gap-2 items-center">
                              <span className="text-sm text-gray-500">New Date{new Date(el?.date).toDateString()}</span>
              ...
              <div className="w-full md:w-1/2 space-y-8"></div>
                ...
                <div className="w-full grid grid-cols-2 gap-2">
                  {task?.assets?.map((el, index) => (
                    <img key={index} src="el" alt={task.title} className="w-full rounded h-28 md:h-36 2x1:h-52 cursor-pointer transition-all duration-700 hover:scale-125 hover:z-50"/>
                  ))}
                </div>
              </div>
